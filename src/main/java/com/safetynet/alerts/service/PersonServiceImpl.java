...
public class PersonServiceImpl implements PersonServiceI {
	...
	public Person postPerson(Person person) {
		...
		log.debug("envoi de la personne à créer au dao : " + person);
	...
	public Person putPerson(Person personToPut) {
		...
		Person person = personDao.findPersonByFirstNameAndLastName(personToPut.getFirstName(),
				personToPut.getLastName());
